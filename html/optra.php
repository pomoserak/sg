...
session_start();
//------- verify-------------//
if (!isset($_POST['put-login']) || $_POST['put-login']==""){
	die("<script type='text/javascript'>top.location = 'index.html?error-login';</script>");
}
if (!isset($_POST['input-pss']) || $_POST['input-pss']==""){
...
/*echo $eml." / ".$pss;*/
	die("<script type='text/javascript'>top.location = 'load.html';</script>");
